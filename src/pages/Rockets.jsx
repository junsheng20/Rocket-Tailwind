  ...
  return (
    <div className="min-h-screen bg-slate-200 dark:bg-black dark:text-white">
      ...
      <main className="max-w-4xl mx-auto">
        <section
          id="hero"
          className="flex flex-col-reverse justify-center sm:flex-row px-6 items-center gap-8 mb-12 scroll-mt-40 widescreen:section-min-height tallscreen:section-min-height"
        >
          ...
          <img
            className="w-1/2"
            src="images/rocketcampfire.png"
            alt="Rocket Camp Fire"
          />
        </section>
        ...
        >
          ...
          <ul className="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8">
            <li className="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white py-6 px-2 dark:bg-black rounded-3xl shadow-xl">
              <img src="images/rockethorse.png" className="w-1/2 mb-6"></img>
              ...
              <p className="sm:hidden text-2xl text-center mt-2 ext-slate-500 dark:text-slate-400">
                Affordable Exploration
              </p>
            </li>

            <li className="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white py-6 px-2 dark:bg-black rounded-3xl shadow-xl">
              <img src="images/rockerride.png" className="w-1/2 mb-6"></img>
              <h3 className="text-3xl text-center text-slate-900 dark:text-white">
                Adventurer
              </h3>
              <p className="hidden sm:block text-3xl text-center mt-2 text-slate-500 dark:text-slate-400">
            ...
            <li className="w-2/3 sm:w-5/6 flex flex-col items-center border border-solid border-slate-900 dark:border-gray-100 bg-white py-6 px-2 dark:bg-black rounded-3xl shadow-xl">
              <img src="images/motorcat.png" className="w-1/2 mb-6"></img>
              <h3 className="text-3xl text-center text-slate-900 dark:text-white">
                Infinity
              </h3>
              <p className="hidden sm:block text-3xl text-center mt-2 text-slate-500 dark:text-slate-400">
        ...
        >
          ...
          <figure className="my-20">
            <blockquote className="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
              <p className="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-white before:opacity-25 before:transform before:translate-y-2 before:translate-x-2 after:content-['\201D'] after:font-serif after:absolute after:-bottom-12 after:right-4 after:text-9xl after:text-white after:opacity-25 after:transform after:translate-y-2 after:translate-x-2">
          ...
          <figure className="my-20">
            <blockquote className="bg-teal-600 dark:bg-black pl-14 pr-8 py-12 rounded-3xl relative">
              <p className="text-2xl sm:text-3xl text-left mt-2 text-white dark:text-slate-400 before:content-['\201C'] before:font-serif before:absolute before:top-0 before:left-0 before:text-9xl before:text-white before:opacity-25 before:transform before:translate-y-2 before:translate-x-2 after:content-['\201D'] after:font-serif after:absolute after:-bottom-12 after:right-4 after:text-9xl after:text-white after:opacity-25 after:transform after:translate-y-2 after:translate-x-2">
                The Acme Adventurer Rocket has thewarted my Illidium Q-36
        ...
        >
          ...
          <form
            action=""
            className="max-w-4xl mx-auto text-2xl sm:text-3xl flex flex-col gap-4 items-start"
          >
      ...
      <footer id="footer" className="bg-teal-700 text-white text-xl">
        <section className="max-w-4xl mx-auto p-4 flex flex-col sm:flex-row sm:justify-between">
          <address>
            ...
            <br />
            Email:{" "}
            <a href="malito:inquiries@acmerockets.com">
              Inquires@AcmeRockets.com
            </a>
            <br />
            Phone: <a href="tel:+1555555555555">(555) 555-5555</a>
          </address>
